                ...
                <div class="row">
                    ...
                    <div class="grid_6">
                        <div class="wrap_18">
                            ...
                            <form id="contact-form" action="e_send.php" method="post" enctype="multipart/form-data">
							...
							<option value="Bangalore West">Bangalore West</option>
                                    ...
                                    <label class="message">
                                        <textarea name="area" id="area" placeholder="Message for the donors (any specifications)" id="area"></textarea>
                                        <span class="empty-message">*This field is required.</span>
