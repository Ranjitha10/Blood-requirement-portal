        ...
        <div data-src="images/blood.jpg">
            <div class="fadeIn camera_caption">
                <h2 class="text_1 color_1">Solutions that you need!</h2>
				 <a class="btn_1" href="e_about.php">More info</a>
    ...
    <div class="row wrap_1 wrap_5">
        <div class="grid_3">
            <div class="box_1">
                ...
                <h3 class="text_2 color_2 maxheight1"><a href="e_info1.php">What is blood requirement portal?</a></h3>
        ...
        <div class="grid_3">
            <div class="box_1">
                ...
                <h3 class="text_2 color_2 maxheight1"><a href="e_info2.php">Why this portal?</a></h3>
                <p class="text_3 color_2 maxheight">
    ...
    *Emergencies such as accidents<br/>
        ...
        <div class="grid_3">
            <div class="box_1">
                ...
                <h3 class="text_2 color_2 maxheight1"><a href="e_info3.php">F.A.Q</a></h3>
                <p class="text_3 color_2 maxheight">
        ...
        <div class="grid_3">
            <div class="box_1">
                ...
                <h3 class="text_2 color_2 maxheight1"><a href="e_info4.php">Who can donate?</a></h3>
                <p class="text_3 color_2 maxheight">
            ...
            <div class="preffix_2 grid_8">
                <h2 class="header_1 wrap_3 color_3">
				 <div class="icon_5"></div>
                  <a href="e_statistics.php"> STATISTICS</a>
                </h2>
            </div>
        </div>
