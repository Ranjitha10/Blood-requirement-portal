...
$msg= "{$_POST['name']} needs blood {$_POST['bloodgroup']} at hospital-{$_POST['hospital']}({$_POST['ba']}) ";

//echo ($msg);

$sql="SELECT ph_number, email_id from donor where blood_group='{$_POST['bloodgroup']}' and area='{$_POST['ba']}' ";
                ...
                <div class="grid_12">
                    ...
                    <nav class="nav put-right">
                        <ul class="sf-menu">
                           ...
                           <li class="current"><a href="ask.php">Ask for Blood</a>
                               <ul>
