                ...
                <div class="row">
                    ...
                    <div class="grid_6">
                        <div class="wrap_18">
                            ...
                            <form id="contact-form" action="e_sendabpos.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="grid_6">
                        <div class="wrap_18">
                            ...
                            <form id="contact-form" action="e_sendabpos.php" method="post">
                                <div class="contact-form-loader"></div>
                                <fieldset>
                                    <div class="row">
                                        <div class="grid_2">
                                            <label class="name">
                                                <input type="text" id="name" name="name" value="" placeholder="Name:" 
                                                       pattern="[A-Za-z]+||[A-Za-z]+\s[A-Za-z]+" required/>
                                                <span class="empty-message">*This field is required.</span>
                                                <span class="error-message">*This is not a valid name.</span>
                                            </label>
                                        </div>
									...
									<div class="row">
                                        ...
                                        <div class="grid_2">
                                            <label class="name">
                                               Area:<select class="border" name="area">
							<option value="Bangalore North">Bangalore North</option>
							<option value="Bangalore South">Bangalore South</option>
							<option value="Bangalore East">Bangalore East</option>
							<option value="Bangalore West">Bangalore West</option>
                                    ...
                                    <label class="message">
                                        <textarea id="name" name="message" placeholder="Blood required at: (type in the exact address)"></textarea>
                                        <span class="empty-message">*This field is required.</span>
                                        <span class="error-message">*The message is too short.</span>
                                    </label>
